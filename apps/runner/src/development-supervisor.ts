...
export function codexDevelopmentConfig(job: DevelopmentJob): string[] {
  ...
  return [
    ...
    ...["apps", "plugins", "hooks", "memories", "multi_agent", "multi_agent_v2", "browser_use", "browser_use_external",
      "browser_use_full_cdp_access", "in_app_browser", "in_app_chat", "view_image", "artifact", "computer_use", "image_generation",
      "shell_snapshot", "skill_search", "skill_mcp_dependency_install", "workspace_dependencies", "remote_plugin", "code_mode",
