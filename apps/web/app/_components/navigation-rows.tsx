...
import type { NavigationEntry, NavigationGroup } from "../../lib/workspace-navigation";
...
interface NavigationRowsProps {
  ...
  device?: { name: string; isOnline: boolean };
      ...
      footer={(
        <LayoutFooter>
          <HStack gap={3} vAlign="center" padding={3}>
            ...
            />
            <Text type="supporting" maxLines={1}>{device.name}</Text></> : null}
            {accountActions}
          </HStack>
        </LayoutFooter>
      )}
